...
// 2. whenever we request using fetch APi so on the first time it not return a data in promiseResult it return a response object ,on that
//    we do response.json()  then it also return a promise object with promiseResult is our data
