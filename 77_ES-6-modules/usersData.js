...
export const myName = 'Dheeraj' // named convention also wite like that

export default function getFirstUser() {
  return usersData[0]
}

console.log('I am in userData.js file')

// export default usersData
// export {usersData,myName as myNames}
// export { usersData , myName}         // this  convention is Named export
