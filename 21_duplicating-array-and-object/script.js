...
//       it generated in the memory and then assign to userName= @2345 and then after that we create new variable  let userName2 = 'Dheeraj'  the same address is
//       assign to userName2 i.e @2345 Now , when we change it like userName2 = userName2 + 'Sharma ' in memory new address it generated for that new created string
